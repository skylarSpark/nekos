...
typedef struct s_MACHBSTART // Machine Boot Start
{
    u64_t   mb_migc;
    u64_t   mb_chksum;
    u64_t   mb_krlinitstack;    // Kernel stack address
    u64_t   mb_krlitstacksz;    // Kernel size
    u64_t   mb_imgpadr;         // OS Image address
    u64_t   mb_imgsz;           // OS Image size
    u64_t   mb_krlimgpadr;
    u64_t   mb_krlsz;
    u64_t   mb_krlvec;
    u64_t   mb_krlrunmode;
    ...
    u64_t   mb_kservadre;
    u64_t   mb_nextwtpadr;
    u64_t   mb_bfontpadr;   // System font address
    u64_t   mb_bfontsz;     // System font size
    u64_t   mb_fvrmphyadr;  // VRM physical address
    u64_t   mb_fvrmsz;      // VRM size
    u64_t   mb_cpumode;
    u64_t   mb_memsz;
    u64_t   mb_e820padr;
    u64_t   mb_e820nr;
